...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        output_dir="mask2former_kitti_finetuned_color_v2",
    ...
    # Load the dataset
    train_dataset = KITTIDataset(annotations, train_image_dir, instances_txt_dir, transform=train_transform)
    eval_dataset = KITTIDataset(annotations_val, val_image_dir, instances_txt_dir, transform=val_transform)
